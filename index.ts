...
const programStart =async(person:Person)=>{
        ...
        if(ans.select == "staff"){
            console.log(
                chalk.redBright("You approach the staff room. Please feel free to ask any qustion.")
            );
            ...
            if(!studant){
                ...
                console.log(
                    chalk.yellow(`Hello i am ${name.name}. Nice to meet you!`)
                );
                console.log(
                    chalk.yellowBright("New stusant added")
                );
                ...
                console.log(chalk.yellowBright
                    (`Hello i am ${studant.name}. Nice to see you again!`)
                );
                console.log(
                    chalk.yellowBright
